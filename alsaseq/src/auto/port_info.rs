...
pub trait PortInfoExt: 'static {
    ...
    fn get_property_tstamp_overwrite(&self) -> bool;

    fn set_property_tstamp_overwrite(&self, tstamp_overwrite: bool);
    ...
    fn connect_property_tstamp_overwrite_notify<F: Fn(&Self) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId;
...
impl<O: IsA<PortInfo>> PortInfoExt for O {
    ...
    fn get_property_tstamp_overwrite(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"tstamp-overwrite\0".as_ptr() as *const _,
                value.to_glib_none_mut().0,
            );
            value
                .get()
                .expect("Return Value for property `tstamp-overwrite` getter")
                .unwrap()
        }
    }
    ...
    fn set_property_tstamp_overwrite(&self, tstamp_overwrite: bool) {
        unsafe {
            gobject_sys::g_object_set_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"tstamp-overwrite\0".as_ptr() as *const _,
                Value::from(&tstamp_overwrite).to_glib_none().0,
            );
        }
    }
    ...
    fn connect_property_tstamp_overwrite_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_tstamp_overwrite_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut alsaseq_sys::ALSASeqPortInfo,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
