...
pub fn client_id_list() -> Result<Vec<u8>, glib::Error> {
    unsafe {
        ...
        let _ = ffi::alsaseq_get_client_id_list(&mut entries, entry_count.as_mut_ptr(), &mut error);
        if error.is_null() {
...
pub fn client_info(client_id: u8) -> Result<ClientInfo, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_client_info(client_id, &mut client_info, &mut error);
        if error.is_null() {
...
pub fn client_pool(client_id: u8) -> Result<ClientPool, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_client_pool(client_id, &mut client_pool, &mut error);
        if error.is_null() {
...
pub fn port_id_list(client_id: u8) -> Result<Vec<u8>, glib::Error> {
    unsafe {
        ...
        let mut entry_count = mem::MaybeUninit::uninit();
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_port_id_list(
            client_id,
            &mut entries,
...
pub fn port_info(client_id: u8, port_id: u8) -> Result<PortInfo, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_port_info(client_id, port_id, &mut port_info, &mut error);
        if error.is_null() {
...
pub fn queue_id_list() -> Result<Vec<u8>, glib::Error> {
    unsafe {
        ...
        let mut entry_count = mem::MaybeUninit::uninit();
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_queue_id_list(&mut entries, entry_count.as_mut_ptr(), &mut error);
        if error.is_null() {
            Ok(FromGlibContainer::from_glib_full_num(
                entries,
                entry_count.assume_init() as usize,
...
pub fn queue_info_by_id(queue_id: u8) -> Result<QueueInfo, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_queue_info_by_id(queue_id, &mut queue_info, &mut error);
        if error.is_null() {
...
//pub fn queue_status(queue_id: u8, queue_status: impl IsA<QueueStatus>) -> Result<(), glib::Error> {
//    unsafe { TODO: call ffi:alsaseq_get_queue_status() }
//}
...
pub fn seq_devnode() -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_seq_devnode(&mut devnode, &mut error);
        if error.is_null() {
...
pub fn seq_sysname() -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_seq_sysname(&mut sysname, &mut error);
        if error.is_null() {
...
//pub fn subscription_list(addr: &Addr, query_type: QuerySubscribeType, entries: /*Unimplemented*/Vec<SubscribeData>) -> Result<(), glib::Error> {
//    unsafe { TODO: call ffi:alsaseq_get_subscription_list() }
//}
...
pub fn system_info() -> Result<SystemInfo, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsaseq_get_system_info(&mut system_info, &mut error);
        if error.is_null() {
