...
bitflags! {
    #[doc(alias = "ALSASeqPortSubscribeFlag")]
    pub struct PortSubscribeFlag: u32 {
        #[doc(alias = "ALSASEQ_PORT_SUBSCRIBE_FLAG_EXCLUSIVE")]
        const EXCLUSIVE = ffi::ALSASEQ_PORT_SUBSCRIBE_FLAG_EXCLUSIVE as u32;
        #[doc(alias = "ALSASEQ_PORT_SUBSCRIBE_FLAG_TIMESTAMP")]
        const TIMESTAMP = ffi::ALSASEQ_PORT_SUBSCRIBE_FLAG_TIMESTAMP as u32;
        #[doc(alias = "ALSASEQ_PORT_SUBSCRIBE_FLAG_TIME_REAL")]
        const TIME_REAL = ffi::ALSASEQ_PORT_SUBSCRIBE_FLAG_TIME_REAL as u32;
    }
}

impl fmt::Display for PortSubscribeFlag {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        <Self as fmt::Debug>::fmt(self, f)
    }
}
...
#[doc(hidden)]
impl IntoGlib for PortSubscribeFlag {
    type GlibType = ffi::ALSASeqPortSubscribeFlag;

    fn into_glib(self) -> ffi::ALSASeqPortSubscribeFlag {
        self.bits()
    }
}

#[doc(hidden)]
impl FromGlib<ffi::ALSASeqPortSubscribeFlag> for PortSubscribeFlag {
    unsafe fn from_glib(value: ffi::ALSASeqPortSubscribeFlag) -> Self {
        Self::from_bits_truncate(value)
    }
}
...
impl StaticType for PortSubscribeFlag {
    fn static_type() -> Type {
        unsafe { from_glib(ffi::alsaseq_port_subscribe_flag_get_type()) }
    }
}

impl glib::value::ValueType for PortSubscribeFlag {
    type Type = Self;
}

unsafe impl<'a> FromValue<'a> for PortSubscribeFlag {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl ToValue for PortSubscribeFlag {
    fn to_value(&self) -> glib::Value {
        let mut value = glib::Value::for_value_type::<Self>();
        unsafe {
            glib::gobject_ffi::g_value_set_flags(value.to_glib_none_mut().0, self.into_glib());
