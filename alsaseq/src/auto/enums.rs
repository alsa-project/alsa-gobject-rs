...
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "ALSASeqEventTimestampMode")]
pub enum EventTimestampMode {
    #[doc(alias = "ALSASEQ_EVENT_TIMESTAMP_MODE_TICK")]
    Tick,
    #[doc(alias = "ALSASEQ_EVENT_TIMESTAMP_MODE_REAL")]
    Real,
    #[doc(hidden)]
    __Unknown(i32),
}
...
#[doc(hidden)]
impl IntoGlib for EventTimestampMode {
    type GlibType = ffi::ALSASeqEventTimestampMode;

    fn into_glib(self) -> ffi::ALSASeqEventTimestampMode {
        match self {
            Self::Tick => ffi::ALSASEQ_EVENT_TIMESTAMP_MODE_TICK,
            Self::Real => ffi::ALSASEQ_EVENT_TIMESTAMP_MODE_REAL,
            Self::__Unknown(value) => value,
        }
    }
}
...
#[doc(hidden)]
impl FromGlib<ffi::ALSASeqEventTimestampMode> for EventTimestampMode {
    unsafe fn from_glib(value: ffi::ALSASeqEventTimestampMode) -> Self {
        match value {
            ffi::ALSASEQ_EVENT_TIMESTAMP_MODE_TICK => Self::Tick,
            ffi::ALSASEQ_EVENT_TIMESTAMP_MODE_REAL => Self::Real,
            value => Self::__Unknown(value),
        }
    }
}
...
impl StaticType for EventTimestampMode {
    fn static_type() -> Type {
        unsafe { from_glib(ffi::alsaseq_event_timestamp_mode_get_type()) }
    }
}

impl glib::value::ValueType for EventTimestampMode {
    type Type = Self;
}

unsafe impl<'a> FromValue<'a> for EventTimestampMode {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl ToValue for EventTimestampMode {
    fn to_value(&self) -> glib::Value {
        let mut value = glib::Value::for_value_type::<Self>();
        unsafe {
            glib::gobject_ffi::g_value_set_enum(value.to_glib_none_mut().0, self.into_glib());
