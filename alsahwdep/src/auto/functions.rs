...
pub fn device_id_list(card_id: u32) -> Result<Vec<u32>, glib::Error> {
    unsafe {
        ...
        let _ = ffi::alsahwdep_get_device_id_list(
            card_id,
            &mut entries,
...
pub fn device_info(card_id: u32, device_id: u32) -> Result<DeviceInfo, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsahwdep_get_device_info(card_id, device_id, &mut device_info, &mut error);
        if error.is_null() {
...
pub fn hwdep_devnode(card_id: u32, device_id: u32) -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsahwdep_get_hwdep_devnode(card_id, device_id, &mut devnode, &mut error);
        if error.is_null() {
...
pub fn hwdep_sysname(card_id: u32, device_id: u32) -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsahwdep_get_hwdep_sysname(card_id, device_id, &mut sysname, &mut error);
        if error.is_null() {
