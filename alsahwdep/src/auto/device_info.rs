...
impl<O: IsA<DeviceInfo>> DeviceInfoExt for O {
    ...
    fn get_property_iface(&self) -> IfaceType {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"iface\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().expect("Return Value for property `iface` getter").unwrap()
        }
    }
    ...
    fn connect_property_card_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_card_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut alsahwdep_sys::ALSAHwdepDeviceInfo, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
    ...
    fn connect_property_device_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_device_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut alsahwdep_sys::ALSAHwdepDeviceInfo, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<DeviceInfo>
        {
            let f: &F = &*(f as *const F);
            f(&DeviceInfo::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut alsahwdep_sys::ALSAHwdepDeviceInfo, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<DeviceInfo>
        {
            let f: &F = &*(f as *const F);
            f(&DeviceInfo::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_iface_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_iface_trampoline<P, F: Fn(&P) + 'static>(this: *mut alsahwdep_sys::ALSAHwdepDeviceInfo, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<DeviceInfo>
        {
            let f: &F = &*(f as *const F);
            f(&DeviceInfo::from_glib_borrow(this).unsafe_cast_ref())
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::iface\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_iface_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut alsahwdep_sys::ALSAHwdepDeviceInfo, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<DeviceInfo>
        {
            let f: &F = &*(f as *const F);
            f(&DeviceInfo::from_glib_borrow(this).unsafe_cast_ref())
