...
pub fn device_id_list(card_id: u32) -> Result<Vec<u32>, glib::Error> {
    unsafe {
        ...
        let _ = ffi::alsarawmidi_get_device_id_list(
            card_id,
            &mut entries,
...
pub fn rawmidi_devnode(card_id: u32, device_id: u32) -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsarawmidi_get_rawmidi_devnode(card_id, device_id, &mut devnode, &mut error);
        if error.is_null() {
...
pub fn rawmidi_sysname(card_id: u32, device_id: u32) -> Result<glib::GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsarawmidi_get_rawmidi_sysname(card_id, device_id, &mut sysname, &mut error);
        if error.is_null() {
...
pub fn subdevice_id_list(
    ...
    unsafe {
        ...
        let mut entry_count = mem::MaybeUninit::uninit();
        let mut error = ptr::null_mut();
        let _ = ffi::alsarawmidi_get_subdevice_id_list(
            card,
            device,
            direction.into_glib(),
            &mut entries,
...
pub fn substream_info(
    ...
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = ffi::alsarawmidi_get_substream_info(
            card_id,
            device_id,
            direction.into_glib(),
            subdevice_id,
