...
pub fn get_device_id_list(card_id: u32) -> Result<Vec<u32>, glib::Error> {
    unsafe {
        ...
        let _ = alsarawmidi_sys::alsarawmidi_get_device_id_list(
            card_id,
            &mut entries,
...
pub fn get_rawmidi_devnode(card_id: u32, device_id: u32) -> Result<GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = alsarawmidi_sys::alsarawmidi_get_rawmidi_devnode(
            card_id,
            device_id,
            &mut devnode,
            &mut error,
...
pub fn get_rawmidi_sysname(card_id: u32, device_id: u32) -> Result<GString, glib::Error> {
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = alsarawmidi_sys::alsarawmidi_get_rawmidi_sysname(
            card_id,
            device_id,
            &mut sysname,
            &mut error,
...
pub fn get_substream_info(
    ...
    unsafe {
        ...
        let mut error = ptr::null_mut();
        let _ = alsarawmidi_sys::alsarawmidi_get_substream_info(
            card_id,
            device_id,
            direction.to_glib(),
            subdevice_id,
