...
impl<O: IsA<StreamPair>> StreamPairExt for O {
    fn create_source(&self) -> Result<glib::Source, glib::Error> {
        unsafe {
            ...
            let _ = ffi::alsarawmidi_stream_pair_create_source(
    ...
    fn drain_substream(&self, direction: StreamDirection) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_drain_substream(
                self.as_ref().to_glib_none().0,
                direction.into_glib(),
                &mut error,
            );
    ...
    fn drop_substream(&self, direction: StreamDirection) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_drop_substream(
                self.as_ref().to_glib_none().0,
                direction.into_glib(),
                &mut error,
            );
    ...
    fn substream_info(&self, direction: StreamDirection) -> Result<SubstreamInfo, glib::Error> {
        unsafe {
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_get_substream_info(
                self.as_ref().to_glib_none().0,
                direction.into_glib(),
                &mut substream_info,
                &mut error,
    ...
    fn open(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_open(
                self.as_ref().to_glib_none().0,
                card_id,
                device_id,
                subdevice_id,
    ...
    fn set_substream_params(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_set_substream_params(
                self.as_ref().to_glib_none().0,
                direction.into_glib(),
    ...
    fn write_to_substream(&self, buf: &[u8]) -> Result<(), glib::Error> {
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::alsarawmidi_stream_pair_write_to_substream(
                self.as_ref().to_glib_none().0,
                buf.to_glib_none().0,
                buf_size,
                &mut error,
