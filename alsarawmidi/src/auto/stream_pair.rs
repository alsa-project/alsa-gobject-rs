...
impl StreamPair {
    pub fn new() -> StreamPair {
        unsafe { from_glib_full(alsarawmidi_sys::alsarawmidi_stream_pair_new()) }
    }
}
...
pub trait StreamPairExt: 'static {
    ...
    fn set_substream_params<P: IsA<SubstreamParams>>(
        &self,
...
impl<O: IsA<StreamPair>> StreamPairExt for O {
    fn create_source(&self) -> Result<glib::Source, glib::Error> {
        unsafe {
            ...
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_create_source(
    ...
    fn drain_substream(&self, direction: StreamDirection) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_drain_substream(
                self.as_ref().to_glib_none().0,
                direction.to_glib(),
                &mut error,
            );
    ...
    fn drop_substream(&self, direction: StreamDirection) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_drop_substream(
                self.as_ref().to_glib_none().0,
                direction.to_glib(),
                &mut error,
            );
    ...
    fn get_substream_info(&self, direction: StreamDirection) -> Result<SubstreamInfo, glib::Error> {
        unsafe {
            ...
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_get_substream_info(
                self.as_ref().to_glib_none().0,
                direction.to_glib(),
                &mut substream_info,
                &mut error,
    ...
    fn open(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_open(
                self.as_ref().to_glib_none().0,
                card_id,
                device_id,
                subdevice_id,
                access_modes.to_glib(),
                open_flag,
                &mut error,
            );
            if error.is_null() {
    ...
    fn set_substream_params<P: IsA<SubstreamParams>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_set_substream_params(
                self.as_ref().to_glib_none().0,
                direction.to_glib(),
    ...
    fn write_to_substream(&self, buf: &[u8]) -> Result<(), glib::Error> {
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = alsarawmidi_sys::alsarawmidi_stream_pair_write_to_substream(
                self.as_ref().to_glib_none().0,
                buf.to_glib_none().0,
                buf_size,
                &mut error,
    ...
    fn connect_handle_disconnection<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn handle_disconnection_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut alsarawmidi_sys::ALSARawmidiStreamPair,
            f: glib_sys::gpointer,
        ) where
            P: IsA<StreamPair>,
        {
    ...
    fn connect_handle_messages<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn handle_messages_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut alsarawmidi_sys::ALSARawmidiStreamPair,
            f: glib_sys::gpointer,
        ) where
            P: IsA<StreamPair>,
