...
int main() {
    ...
    PRINT_CONSTANT((gint) ALSASEQ_EVENT_TIMESTAMP_MODE_REAL);
    PRINT_CONSTANT((gint) ALSASEQ_EVENT_TIMESTAMP_MODE_TICK);
    ...
    PRINT_CONSTANT((guint) ALSASEQ_PORT_SUBSCRIBE_FLAG_EXCLUSIVE);
    PRINT_CONSTANT((guint) ALSASEQ_PORT_SUBSCRIBE_FLAG_TIMESTAMP);
    PRINT_CONSTANT((guint) ALSASEQ_PORT_SUBSCRIBE_FLAG_TIME_REAL);
