...
#[repr(C)]
pub struct _ALSARawmidiStreamPairPrivate {
    _data: [u8; 0],
...
#[repr(C)]
pub struct _ALSARawmidiSubstreamInfoPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}
...
#[repr(C)]
pub struct _ALSARawmidiSubstreamParamsPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}
...
#[repr(C)]
pub struct _ALSARawmidiSubstreamStatusPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}
